      ...
      <div className="card w-full max-w-md animate-in fade-in zoom-in duration-500">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="text-right mt-2">
            <Link to="/forgot" className="block text-xs font-bold uppercase tracking-widest text-slate-400 mb-2 hover:text-indigo-600 font-semibold tracking-tight hover:underline">Forgot Password?</Link>
          </div>
          <div className="pt-2">
            <button className="btn w-full btn-primary" disabled={isSubmitting}>Login</button>
          </div>


          <div className="text-center muted mt-2">
            Don't have an account? <Link to="/register" className="text-indigo-500 hover:text-indigo-600 font-semibold">Register</Link>
          </div>
        </form>
      </div>
    </div>
